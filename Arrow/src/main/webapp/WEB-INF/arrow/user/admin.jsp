...
<c:if test="${!empty principal }">
	...
	<nav class="navbar navbar-expand-sm p-0 m-0" style="background-color: #ffffff;">
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-center" id="mynavbar" style="height: 100px;">
				<ul class="navbar-nav" style="font-size: 20px;">
					<li class="nav-item p-5">
						<a class="nav-link" href="#">게시글 작성
							<i class="icon-angle-down"></i>
						</a>
					</li>
					<li class="nav-item p-5">
						<a class="nav-link" href="#">전시품 등록</a>
					</li>
				</ul>
 			</div>
		</div>
	...
	<!-- 대현 수정 240324 -->
	<div class="container-fluid p-0 border border-1 border-dark" align="center" style="margin-top: 100px;">
