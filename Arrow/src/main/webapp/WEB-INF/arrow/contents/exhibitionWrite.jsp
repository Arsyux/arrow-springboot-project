	...
	<!-- 장소 -->
		<tr>
			...
			<label for = "startDateExhibit" style = "font-size: 16px; font-weight: bold; margin-right:20px;">전시 기간</label>
				<input type="text" class="startDateExhibit" id="startDateExhibit" name="startDateExhibit" title="시작날짜" placeholder="시작일자"/> 
				-
				<input type="text" class="endDateExhibit" id="endDateExhibit" name="endDateExhibit" title="종료날짜" placeholder="종료일자"/>			
